...
import { View, Animated, Platform, ViewPropTypes, Text } from "react-native";
...
export default class FlipCard extends Component {
  ...
  onGesture(gestureName, gestureState) {
    ...
    switch (gestureName) {
      case SWIPE_UP:
        this.props.flipVertical ? this._toggleCard() : "";
        break;
      case SWIPE_DOWN:
        this.props.flipVertical ? this._toggleCard() : "";
        break;
      case SWIPE_LEFT:
        this.props.flipHorizontal ? this._toggleCard() : "";
        break;
      case SWIPE_RIGHT:
        this.props.flipHorizontal ? this._toggleCard() : "";
        break;
      case ON_PRESS:
        if (this.props.pressable && this.props.pressableCustomFunc) {
          this.props.onPressed();
        } else if (this.props.pressable && !this.props.pressableCustomFunc) {
          this._toggleCard();
        }
        break;
      case ON_LONGPRESS:
        this.props.longPressable ? this.props.onLongPressed() : "";
        break;
    }
  }
  ...
  render() {
    ...
    if (this.props.swipeable) {
      ...
      return (
        <Animated.View
          {...this.props}
          style={[{flex: 1, transform: transform }, this.props.style]}
        >
          {render_side}
        </Animated.View>
      );
...
FlipCard.propTypes = {
  ...
  pressableCustomFunc:PropTypes.bool,
  longPressable: PropTypes.bool,
...
export class Back extends Component {
  render() {
    ...
    return (
      <View
        style={[this.props.style, { transform: transform }]}
